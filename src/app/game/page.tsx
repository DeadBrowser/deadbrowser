...
const styles: { [key: string]: React.CSSProperties } = {
    container: {
        ...
        overflow: 'hidden',
        touchAction: 'none',
        // Remove container padding - let header handle it
    ...
    header: {
        ...
        alignItems: 'center',
        padding: '12px 16px',
        // Enhanced safe area padding for Dynamic Island/notch - add extra 8px for visibility
        paddingTop: 'calc(max(12px, env(safe-area-inset-top)) + 8px)',
